...
(async () => {
    ...
    const coffeeMachineTD = await wotHelper.fetch("http://localhost:8081/coffee-machine");
    // Alternatively, this Thing self-hosts its TD at http://plugfest.thingweb.io:8081/coffee-machine that you can fetch
    const presenceSensorTD = await wotHelper.fetch("mqtt://test.mosquitto.org/PresenceSensor");
    const smartClockTD = await wotHelper.fetch("coap://localhost:5686/smart-clock");
