        ...
        WoT.produce(thingDescription).then((thing: WoT.ExposedThing) => {
            ...
            thing.setPropertyReadHandler(
                ...
                tracedPropertyReadHandler("allAvailableResources", async () => {
                    return traceDatabaseOperation("select", "resources", async () => {
            ...
            thing.setActionHandler(
                ...
                tracedActionHandler("makeDrink", async (_params, options) => {
                    return traceBusinessLogic("drinkPreparation", async () => {
                        // Default values
                        ...
                        return traceValidation("resourceAvailability", newResources, async () => {
                            ...
                            return traceDatabaseOperation("update", "resources", async () => {
            ...
            thing.setActionHandler(
                ...
                tracedActionHandler("setSchedule", async (params, options) => {
                    return traceBusinessLogic("scheduleManagement", async () => {
                        const paramsp = params ? ((await (params as any).value()) as Record<string, unknown>) : null;

                        // Check if required parameters are provided
                        return traceValidation("scheduleParameters", paramsp, async () => {
                            if (paramsp != null && typeof paramsp === "object" && "time" in paramsp && "mode" in paramsp) {
                                ...
                                return traceDatabaseOperation("insert", "schedules", async () => {
