...
servient
    ...
    .then(async (WoT) => {
        try {
            const td = await WoT.requestThingDescription("coap://localhost:5684/coap-calculator-content-negotiation");
            ...
            let subtract = await thing.invokeAction("subtract", 1, { formIndex: 3 })
